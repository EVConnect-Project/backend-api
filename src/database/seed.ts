...
export async function seedDatabase(dataSource: DataSource) {
  ...
  if (existingUsers > 0) {
    ...
    if (existingMechanics === 0) {
      ...
      const mechanics = await userRepository.find({ where: { role: 'mechanic' } });
      ...
      if (mechanics.length === 0) {
        ...
        const mechanicUsers = [
          ...
          {
            phoneNumber: "+94771234503",
            password: hashedPassword,
            name: "All-Round Auto",
            role: "mechanic" as const,
          },
          {
            phoneNumber: "+94771234504",
            password: hashedPassword,
            name: "Mobile Mechanic",
            role: "mechanic" as const,
          },
          {
            phoneNumber: "+94771234505",
            password: hashedPassword,
            name: "Premium Auto",
            role: "mechanic" as const,
          },
          {
            phoneNumber: "+94771234506",
            password: hashedPassword,
            name: "Budget Repairs",
            role: "mechanic" as const,
          },
      ...
      const sampleMechanics = [
        {
          ...
          phone: "+94771234567",
          description:
            "Fast and reliable emergency roadside assistance. Available 24/7 for battery jumps, tire changes, and minor repairs.",
          available: true,
          pricePerHour: 75.0,
          completedJobs: 156,
        ...
        },
        {
          ...
          phone: "+94772345678",
          description:
            "Specialized in electric vehicle maintenance and repair. Expert in EV battery systems and charging infrastructure.",
          available: true,
          pricePerHour: 120.0,
          completedJobs: 89,
        ...
        },
        {
          ...
          phone: "+94773456789",
          description:
            "Comprehensive auto repair services for all makes and models. From routine maintenance to major repairs.",
          available: true,
          pricePerHour: 85.0,
          completedJobs: 234,
  ...
  const sampleMechanics = [
    ...
    },
    {
      ...
      phone: "+94774567890",
      description:
        "We come to you! Mobile mechanic service available across Colombo. No need to tow your vehicle.",
      available: true,
      pricePerHour: 95.0,
      completedJobs: 178,
      licenseNumber: "MEC-2024-004",
    ...
    },
    {
      ...
      phone: "+94775678901",
      description:
        "Exclusive service for luxury and performance vehicles. Expert technicians with factory training.",
      available: false,
      pricePerHour: 200.0,
      completedJobs: 312,
      licenseNumber: "MEC-2024-005",
    ...
    },
    {
      ...
      phone: "+94776789012",
      description:
        "Quality auto care at affordable prices. Perfect for routine maintenance and basic repairs.",
      available: true,
      pricePerHour: 50.0,
      completedJobs: 67,
      licenseNumber: "MEC-2024-006",
