...
async function bootstrap() {
  ...
  const allowedOrigins = isDevelopment
    ...
    : (process.env.ALLOWED_ORIGINS?.split(',') || ['https://your-frontend-url.com']);
  ...
  console.log(`🔐 CORS enabled for: ${isDevelopment ? 'all localhost origins (dev mode)' : process.env.ALLOWED_ORIGINS || 'https://your-frontend-url.com'}`);
}
bootstrap();
