...
export class AddPhoneAndVehicleFields1731897600000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "accepted_privacy_policy"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "accepted_terms"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "connector_type"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "battery_capacity"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "vehicle_model"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "vehicle_brand"`);
        await queryRunner.query(`ALTER TABLE "users" DROP COLUMN IF EXISTS "vehicle_type"`);
