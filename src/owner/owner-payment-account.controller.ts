...
export class OwnerPaymentAccountController {
  constructor(private readonly paymentAccountService: OwnerPaymentAccountService) {}
  ...
  @Patch(':id')
  update(@Request() req, @Param('id') id: string, @Body() updateDto: UpdatePaymentAccountDto) {
