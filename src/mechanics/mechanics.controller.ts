...
export class MechanicsController {
  ...
  async updateMyAvailability(
    ...
    console.log(
      "🔄 Mechanic availability update:",
      req.user.phoneNumber,
      "-> available:",
      available,
    );
    return this.mechanicsService.updateMyAvailability(
      req.user.userId,
      available,
    );
  }
  ...
  async resignMechanicRole(@Request() req) {
    ...
    return {
      message:
        "Your mechanic profile has been removed successfully. You can reapply as a mechanic anytime from the home screen.",
    };
  }
  ...
  async getEmergencyRecommendations(
    ...
    console.log(
      ...
      req.user.phoneNumber,
      "at location:",
      emergencyRequest.lat,
      emergencyRequest.lng,
    );
    return this.mechanicsService.getAIRecommendations(
      emergencyRequest,
      req.user.userId,
    );
  }
  ...
  async sendEmergencyAlert(
    ...
    console.log(
      "🚨 Sending emergency alerts to mechanics:",
      body.mechanicIds,
      "from user:",
      req.user.phoneNumber,
    );
  ...
  async createEmergencyChat(
    ...
    console.log(
      "💬 Creating emergency chat for user:",
      req.user.phoneNumber,
      "with mechanic:",
      body.mechanicId,
    );
  ...
  async getQuickTemplates(@Param("problemType") problemType: string) {
    return {
      templates:
        this.emergencyChatService.getQuickMessageTemplates(problemType),
  ...
  async getChatSummary(
    ...
    return this.emergencyChatService.getEmergencyChatSummary(
      conversationId,
      req.user.userId,
    );
  }
