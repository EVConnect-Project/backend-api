...
export class EnhancedRegisterDto {
  ...
  @ValidateIf(
    (o) => o.batteryCapacity !== undefined && o.batteryCapacity !== null,
  )
  ...
  @ValidateIf(
    (o) =>
      o.connectorType !== undefined &&
      o.connectorType !== null &&
      o.connectorType !== "",
  )
  @IsString({
    message: "connectorType must be a string (for backward compatibility)",
  })
  connectorType?: string;

  @ValidateIf(
    (o) => o.connectorTypes !== undefined && o.connectorTypes !== null,
  )
